...
public class AutoBackwardEncoder extends CommandBase {
  private final DriveSubsystem DriveSubsystem;
  private final double AutoDistance;
  private double LeftSpeed;
  private double RightSpeed;
  /**
   * Creates a new AutoForwardEncoder.
   */
  public AutoBackwardEncoder(DriveSubsystem s_DriveSubsystem, double v_AutoDistance, double v_LeftSpeed, double v_RightSpeed) {
  ...
  public void initialize() {
    System.out.println("Backward Before Reset");
    ...
    DriveSubsystem.zeroRightPosition();
    System.out.println("Backwards" + AutoDistance);
  }
